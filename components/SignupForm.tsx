...
export default function SignupForm(): React.JSX.Element {
  ...
  const handleSignup = async () => {
    firebaseApi
      ...
      .then((res) => {
        firebaseApi
          .updateProfile(res.user, { displayName: userInfo.displayName })
          .then(() => {
            dispatch({
              type: "UPDATE",
              payload: { ...state.data, displayName: res.user.displayName },
            });
    ...
    <FormContainer>
      <View>
        ...
        <FormInput
          ...
          onTextChange={(e) =>
            setUserInfo({ ...userInfo, displayName: e.nativeEvent.text })
          }
        />
        <FormInput
          label="Password"
          ...
          onTextChange={(e) =>
            setUserInfo({ ...userInfo, password: e.nativeEvent.text })
          }
        />
        <FormInput
          ...
          onTextChange={(e) =>
            setUserInfo({ ...userInfo, confirmPassword: e.nativeEvent.text })
          }
        />
